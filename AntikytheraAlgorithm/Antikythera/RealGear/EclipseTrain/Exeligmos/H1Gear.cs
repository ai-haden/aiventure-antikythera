namespace Antikythera.RealGear.EclipseTrain.Exeligmos
{
    ...
    /// </summary>
    public class H1Gear : Gear
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="H1Gear"/> class. Using the modeled (calculated) parameters from the authors
        /// listed in Table 3, p. 224.
        /// </summary>
        public H1Gear()
            : base("H1", 60, 1.122, 15.78, 1.444)
