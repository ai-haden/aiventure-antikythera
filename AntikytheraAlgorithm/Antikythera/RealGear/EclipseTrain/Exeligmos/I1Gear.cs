namespace Antikythera.RealGear.EclipseTrain.Exeligmos
{
    ...
    /// </summary>
    public class I1Gear : Gear
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="I1Gear"/> class. Using the modeled (calculated) parameters from the authors
        /// listed in Table 3, p. 224.
        /// </summary>
        public I1Gear()
            : base("I1", 60, 1.122, 13.8, 1.444)
        { }
    }
}
