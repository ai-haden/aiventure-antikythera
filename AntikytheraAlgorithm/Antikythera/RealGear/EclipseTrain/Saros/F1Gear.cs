namespace Antikythera.RealGear.EclipseTrain.Saros
{
    ...
    /// </summary>
    public class F1Gear : Gear
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="F1Gear"/> class. Using the modeled (calculated) parameters from the authors
        /// listed in Table 3, p. 224, Table 9, p.229.
        /// </summary>
        public F1Gear()
            : base("F1", 53, 1.122, 13.939, 1.652)
        { }
    }
}
