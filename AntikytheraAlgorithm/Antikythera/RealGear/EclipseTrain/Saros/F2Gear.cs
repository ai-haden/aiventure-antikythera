namespace Antikythera.RealGear.EclipseTrain.Saros
{
    ...
    /// </summary>
    public class F2Gear : Gear
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="F2Gear"/> class. Using the modeled parameters from the authors
        /// listed in Table 1, p. 221 , Table 9, p.229.
        /// </summary>
        public F2Gear()
            : base("F2", 30, 1.122, 7.89, 1.649)
        { }
    }
}
