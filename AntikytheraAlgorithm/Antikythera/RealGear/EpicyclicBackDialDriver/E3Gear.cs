namespace Antikythera.RealGear.LunarTrain.Epicyclic
{
    ...
    /// </summary>
    public class E3Gear : Gear
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="E3Gear"/> class. Using the modeled (calculated) parameters from the authors
        /// listed in Table 3, p. 224.
        /// </summary>
        public E3Gear()
            : base("E3", 223, 1.122, 51.29, 1.445)
        { }
    }
}
