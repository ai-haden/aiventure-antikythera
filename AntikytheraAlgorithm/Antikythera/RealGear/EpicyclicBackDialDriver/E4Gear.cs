namespace Antikythera.RealGear.LunarTrain.Epicyclic
{
    ...
    /// </summary>
    public class E4Gear : Gear
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="E4Gear"/> class. Using the modeled (calculated) parameters from the authors
        /// listed in Table 3, p. 224, Table 9, p.229. This is the inner-seated gear to its mate E3.
        /// </summary>
        public E4Gear()
            : base("E4", 188, 1.122, 49.444, 1.652)
        { }
    }
}
