namespace Antikythera.RealGear.LunarTrain.Epicyclic
{
    ...
    /// </summary>
    public class E1Gear : Gear
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="E1Gear"/> class. This gear is subject to higher tolerances. Using the 
        /// modeled (calculated) parameters from the authors. Using authors numbers since measured values are disparate for two 
        /// gears (e1 and e2) have the same tooth count.
        /// </summary>
        public E1Gear()
            : base("E1", 32, 1.122, 9.44, 1.851)
            // Check this with E2 gear.
        { }
    }
}
