namespace Antikythera.RealGear.LunarTrain.Epicyclic
{
    ...
    /// </summary>
    public class E5Gear : Gear
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="E5Gear"/> class. Using the modeled (calculated) parameters from the authors
        /// listed in Table 3, p. 224, Table 9, p.229.
        /// </summary>
        public E5Gear()
            : base("E5", 50, 1.122, 13.15, 1.651)
        { }
    }
}
