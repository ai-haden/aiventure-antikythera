namespace Antikythera.RealGear.LunarTrain.Epicyclic
{
    ...
    /// </summary>
    public class K2Gear : Gear
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="K2Gear"/> class. Using the modeled (calculated) parameters from the authors
        /// listed in Table 3, p. 224.
        /// </summary>
        public K2Gear()
            : base("K2", 50, 1.122, 13.15, 1.651)
        { }
    }
}
