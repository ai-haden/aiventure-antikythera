namespace Antikythera.RealGear.LunarTrain.LunarTransition.AlternativeGear
{
    /// <summary>
    ...
    /// </summary>
    public class C2Gear49 : Gear
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C2Gear49"/> class.
        /// </summary>
        public C2Gear49()
            : base("C2-49", 49, 1.122, 11.3, 1.4490)
        { }
    }
}
