...
namespace FormControls.Circle
{
    public partial class CircleControl : UserControl
    {
        ...
        private void SetAngle(MarkerSet ms, float value, float angleChange, AngleChangedArgs.MouseState state)
        {
            ms.Angle = AdjustAngle(value);
            Redraw();
        ...
        public float PrimaryMarkerAngle
        {
            ...
            set { SetAngle(PrimaryMarkerSet, value, 0.0f, AngleChangedArgs.MouseState.Unknown); }
        }
        ...
        private void CircleControl_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            else if (FindMarkerSetUnderMouse(e.Location, MouseButtons.Left | MouseButtons.Middle | MouseButtons.Right) !=
                     null)
            {
                mouseMode = MouseMode.CanDrag;
            }
